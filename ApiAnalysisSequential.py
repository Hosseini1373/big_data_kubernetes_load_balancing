...
1. Makes 10 requests to the API endpoint `https://test.questionpdf.init-lab.ch/query?query=who%20is%20john` 
...
def visualize_results(success_count, timeout_count, average_response_time, success_response_times):
    ...
    if success_count > 0:
        ...
        plt.savefig(f'images/K8/api_test_results.png')
        ...
        plt.savefig(f'images/K8/response_time_distribution.png')
        ...
        plt.savefig(f'images/K8/response_time_box_plot.png')
        ...
        plt.savefig(f'images/K8/response_time_percentiles.png')
